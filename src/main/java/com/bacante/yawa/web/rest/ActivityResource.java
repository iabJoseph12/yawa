...
/**
 * REST controller for managing {@link com.bacante.yawa.domain.Activity}.
 */
@RestController
@RequestMapping("/api")
public class ActivityResource {
    ...
    public ResponseEntity<Activity> updateActivity(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, activity.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Activity> partialUpdateActivity(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, activity.getId())
        );
    }
