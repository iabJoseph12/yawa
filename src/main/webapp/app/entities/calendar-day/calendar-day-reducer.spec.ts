...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALENDARDAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALENDARDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALENDARDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALENDARDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALENDARDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALENDARDAY actions', async () => {
      const expectedActions = [
        {
