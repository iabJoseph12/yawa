...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './session.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SESSION actions', async () => {
      const expectedActions = [
        {
